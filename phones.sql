...
ALTER TABLE phones ADD COLUMN IF NOT EXISTS active BOOLEAN DEFAULT TRUE;
ALTER TABLE phones ADD COLUMN IF NOT EXISTS market_status VARCHAR(50) DEFAULT 'ACTIVE';
